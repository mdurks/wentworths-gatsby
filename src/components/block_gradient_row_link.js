...
const Block_gradient_row_link = props => {
  ...
  const Div__gradient_row_link = styled.div`
    ...
    background: linear-gradient(
      to ${props.img_alignment},
      #f9f6ee 49.99%,
      ${props.tint_colour} 50%
    );
    margin-bottom: 6px;
    ...
    .text {
      position: absolute;
      left: ${props.img_alignment === "right" ? "0" : "40%"};
      display: flex;
      align-items: center;
      height: 100%;
      width: 60%;
      text-transform: uppercase;
      text-align: ${props.img_alignment === "right" ? "right" : "left"};

      ${bp_min_desktop} {
        width: 50%;
        left: ${props.img_alignment === "right" ? "0" : "50%"};
      }
    ...
    .img {
      position: absolute;
      width: 33.33%;
      left: ${props.img_alignment === "right" ? "66.66%" : "0%"};

      ${bp_min_desktop} {
        width: 50%;
        left: ${props.img_alignment === "right" ? "50%" : "0%"};
      }
  ...
  return (
    <>
      <Div__gradient_row_link className={props.img_alignment}>
